...
fortheen_th_over = st.number_input('14th_over', value=150, placeholder='Enter run after 16th over')
second_nd_wicket = st.number_input('2nd_wicket', value=9, placeholder='Enter wicket after 16th over')
